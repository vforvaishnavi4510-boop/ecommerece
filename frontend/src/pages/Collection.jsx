...
//import { toLowerCase } from './../../node_modules/zod/src/v4/core/api';
...
const Collection = () => {
  ...
  return (
    <div className='flex flex-co sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
    ...
    <div className='flex-1'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 gap-y-6'>
        {
          filterProducts.map((item,index)=>{return(
