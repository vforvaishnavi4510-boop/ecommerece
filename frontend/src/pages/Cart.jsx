  ...
  return (
    <div className='border-t pt-14'>
      ...
      return (
        ...
        <img  onClick={(e)=> e.target.value ===''|| e.target.value ==='0' ? null : updateQuantity(item._id,item.size ,Number(e.target.value))} className='w-4 mr-4 sm:w-5 cursor-pointer ' src={assets.bin_icon} alt=""/>
  </div>
  )
        })
     }
